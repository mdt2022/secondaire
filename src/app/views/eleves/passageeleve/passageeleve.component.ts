...
@Component({
  selector: 'app-passageeleve',
  standalone: true,
  imports: [ CommonModule,
    RouterLink,
    ReactiveFormsModule],
  templateUrl: './passageeleve.component.html',
  styleUrl: './passageeleve.component.scss'
})
export class PassageeleveComponent implements OnInit{
